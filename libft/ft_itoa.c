...
static int	int_len(long num, int str_s)
{
	long	num_l;
...
static void	is_neg(long neg, char *str_n)
{
	if (neg < 0)
		str_n[0] = '-';
}

static char	*is_zero(char *str_n)
{
	str_n[0] = '0';
	str_n[1] = '\0';
	return (str_n);
...
static void	logic(long num, char *str_n, int str_s)
{
	str_n[str_s--] = '\0';
	while (num > 0)
	{
